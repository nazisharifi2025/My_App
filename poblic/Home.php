...
<body class="h-screen w-full bg-gray-100 text-white flex py-4">
    <div class="w-[35%] mx-auto h-[90%] relative shadow-md shadow-gray-500 rounded-xl text-gray-600  bg-gray-100 my-3">
